...
public class SettingsService extends Service {
    ...
    public void setFlightMode(ContentResolver cr, int state){
                    ...
                    if(isEnabled!=(state>0)){
                        ...
                        if(state>0)Toast.makeText(getBaseContext(),"Flight mode is now ENABLED.",Toast.LENGTH_SHORT).show();
                        if(state==0)Toast.makeText(getBaseContext(),"Flight mode is now DISABLED.",Toast.LENGTH_SHORT).show();
                    }else{
